...
export default function Vestuario() {
  ...
  const { data: products, isLoading: productsLoading } = useQuery<StoreProduct[]>({
    queryKey: ["/api/store/products?productType=vestuario"],
  });
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-9"
              data-testid="input-search-vestuario"
            />
          </div>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground">
                Em breve teremos uniformes e roupas personalizadas MCG para sua equipe.
              </p>
