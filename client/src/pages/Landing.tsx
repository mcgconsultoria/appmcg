      ...
      <main>
        <section className="relative min-h-screen flex items-center justify-center pt-16">
          ...
          <div className="relative max-w-screen-xl mx-auto px-6 py-20 text-center">
            ...
            <div className="mt-16 p-6 rounded-xl bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <h3 className="text-lg font-semibold">MCG no seu bolso</h3>
                    <p className="text-sm text-muted-foreground">
                      Instale nosso app e acesse de qualquer lugar
                    </p>
                  </div>
                </div>
                <div className="flex flex-row gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-foreground text-background rounded-lg hover:opacity-90 transition-opacity"
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-[10px] leading-none opacity-80">Disponivel no</div>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-[10px] leading-none opacity-80">Baixe na</div>
